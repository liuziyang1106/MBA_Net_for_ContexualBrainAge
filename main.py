...
def get_args_parser():
    ...
    parser.add_argument('--amp',type=bool, default=False, help="If use amp training")
...
def main(args, results):
    ...
    train_dataset = IMG_Folder_with_mask(args.excel_path,args.train_folder, transforms=transforms, mask_type=args.mask_type)
